        ...
        <div className="grid md:grid-cols-3 gap-8">
          {HSE_POINTS.map((point, index) => (
            <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-2xl hover:bg-white/10 transition-colors group">
              <div className="mb-6 bg-industrial-yellow/20 w-16 h-16  flex items-center justify-center text-industrial-yellow group-hover:scale-110 transition-transform duration-300">
                <point.icon size={32} />
              </div>
